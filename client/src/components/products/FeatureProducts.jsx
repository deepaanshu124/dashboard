            ...
            <div className=' justify-center items-center w-[95%] flex-wrap mx-auto xs:gap-2 gap-3 xs:rounded-sm rounded-2xl xs:w-full grid grid-cols-5 sm:grid-cols-2 xs:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 md-lg:grid-cols-2 2xl:grid-cols-4'>
                {
                    ...
                    products.map((p, i) =>
                     ...
                     <div key={i} className='shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] h-[480px] box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; xs:mb-2 w-[319px] xs:ml-1 xs:w-[180px] xs:h-[300px]  border p-2 bg-[#ffffff] rounded-3xl xs:rounded-xl   group transition-all duration-500 hover:shadow-md '>
