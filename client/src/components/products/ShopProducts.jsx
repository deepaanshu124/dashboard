...
const ShopProducts = ({ styles, products }) => {
    ...
    return (
        <div className={`w-full grid ${styles === 'grid' ? 'grid-cols-4 md-lg:grid-cols-2 md:grid-cols-2' : 'grid-cols-1 md-lg:grid-cols-2 md:grid-cols-2'} justify-center items-center px-1 py-3 bg-slate-300`}>
            {
                products.map((p, i) => <div key={i} className=' shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] flex flex-col justify-center items-center h-[480px] my-2 box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; xs:mb-2 w-[319px] xs:ml-1 xs:w-[180px] xs:h-[300px]  border p-2 bg-[#ffffff] rounded-3xl xs:rounded-xl   group transition-all duration-500 hover:shadow-md '>
