...
const Banner = () => {
    ...
    return (
        <div className='bg-slate-200 w-[100%] xs:mx-0  flex flex-wrap justify-center items-center'>
            <div className='w-[100%] relative '>
                <div className=' flex flex-row p-5 xs:p-0 gap-2 xs:flex-col'>
                    ...
                    <div className='w-[80%]   xs:mt-[-13px] xs:w-[95%] overflow-hidden mx-auto'>
                        ...
                        {/* Carousel and Slider */}
                        <div className='mb-3 w-[100%] rounded-md '>
                            <Carousel
                                autoPlay={true}
                                ...
                                {[aa, aaa, as, sa].map((num, index) => (
                                    <Link key={index} to='#'>
                                        {/* <img src={`http://localhost:3000/images/banner/${num}.jpg`} alt="" className='w-[100%]  object-cover rounded-md' /> */}
                        ...
                        <div className="xs:w-[102%]  overflow-hidden xs:pb-2 ">
                            <Slider {...settings} className="gap-2" >
                                {[imga, imga, imga].map((image, index) => (
                                    <div key={index} className='' >
                                        <img src={image} alt="Slide" className='h-[100%]   gap-2 overflow-hidden xs:w-[96%] w-[99%] object-cover rounded-md' />
                                    </div>
                                ))}
                            </Slider>
                        </div>
