    ...
    return (
        <div>
            ...
            <div className='pt-10 h-[80vh]'>
                <div className='w-full justify-center items-center xs:p-0'>
                    <div className=' shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] grid grid-cols xs:w-[90%] xs:h-[100%] w-[540px] h-[631px] mx-auto bg-white rounded-3xl'>
                        <div className='xs:px-6  px-[60px] py-[10px]'>
                        <div className='xs:hidden h-[36px] w-[36px] ml-[200px] m-10 bg-[#FF5A5A] text-center rounded-full'></div>
                            <h2 className='text-center w-full text-xl font-bold'>Create an account</h2>
                            <div>
                                <form onSubmit={register} className='text-slate-600'>
                                    ...
                                    <button className='text-xl font-bold px-8 w-full py-2 bg-red-500 shadow-lg hover:shadow-red-500/30 text-white rounded-xl'>Register</button>
                                </form>
